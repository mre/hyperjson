...
class _TestEncodeBasestringAscii:
    @pytest.mark.skip(reason="AttributeError: module 'hyperjson' has no attribute 'encoder'")
...
class TestRustEncodeBasestringAscii(_TestEncodeBasestringAscii, RustTest):
    pass
